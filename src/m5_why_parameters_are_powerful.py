...
def main():
    ...
    #better_draw_circles(rg.Point(200,200),45)
    even_better_draw_circles(rg.Point(100, 50),40,45,50,'blue')
    even_better_draw_circles(rg.Point(290, 30),32,15,66,'lightgoldenrodyellow')
    even_better_draw_circles(rg.Point(-800,50),40,2,80,'green')
...
def better_draw_circles(point,radi):
    """
...
def even_better_draw_circles(point,radi,num,thick,color):
